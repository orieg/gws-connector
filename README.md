...
| `gws.accounts.add` | Start connecting a new account (returns a pendingId) |
| `gws.accounts.reauth` | Start re-authorizing an account (returns a pendingId) |
| `gws.accounts.complete` | Finalize a pending OAuth flow (poll until success) |
